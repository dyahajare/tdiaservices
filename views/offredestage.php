   ...
   <div class="dropdown-list dropdown-menu dropdown-menu-right shadow " aria-labelledby="alertsDropdown">
           ...
           <div class="topbar" style="background-color:rgb(238, 237, 237);" style="height: 80px;" style="margin-top:0%;">
            ...
            <div style="margin-left:3%;">
                <h1 style="color:#6e0606">La liste des stages</h1>
                <table id="tableAffichage" class="table"> 
                <thead class="table-info" stle="background-color:blue">
                      <tr stle="background-color:blue"><th>Nom</th>
                       <th>type</th><th>Offre</th>
                       <th>Duree</th>
                       <th>Lien</th>
                       </tr></thead>
                        <tbody>
                 <?php foreach($res as $ligne){?>
                  <td><?php echo $ligne['nom_stage'];?></td>
                   <td><?php echo $ligne['type_stage'];?></td>
                   <td><?php echo $ligne['offre_stage'];?></td>
                   <td><?php echo $ligne['durée_stage'];?></td>
                   <td><a href="<?php echo $ligne['lien_offre'];?>"><?php echo $ligne['lien_offre'];?></a></td>
                   </tbody>
        <?php }?>
