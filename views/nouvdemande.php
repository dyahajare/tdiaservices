...
<body> 
   ...
   <div class="dropdown-list dropdown-menu dropdown-menu-right shadow " aria-labelledby="alertsDropdown">
           ...
           <div class="topbar" style="background-color:rgb(238, 237, 237);" style="height: 80px;" style="margin-top:0%;">
            ...
            <div class="card shadow mb-4" style="margin:5%">
        ...
        <div class="card-body">
        <form method="post" action="demandehandler.php" enctype="multipart/form-data">
                <fieldset class="p-3 mb-2 bg-light text-dark">
                    <div class="form-group">			
                        <div class="form-group"><label>Choisir le type de la demande</label> <br>
                        <select required="" id="typeatt" class="form-control" name="typeatt">
                        <option value=""></option>
                        <option style="background-color:#e8e8ff" value="ATTESTATION DE POURSUITE D'ÉTUDES">[Service Scolarité] ATTESTATION DE POURSUITE D'ÉTUDES</option>
                        <option style="background-color:#e8e8ff" value="RELEVE DE NOTES">[Service Scolarité] RELEVE DE NOTES</option>
                        <option style="background-color:#ff453f" value="CARTE ETUDIANT">[Service Scolarité] CARTE ETUDIANT</option>
                        <option style="background-color:#e8e8ff" value="DEMANDE DE RECTIFICATION DES DONNEES">[Service Scolarité] DEMANDE DE RECTIFICATION DES DONNEES</option>
                        <option style="background-color:#e8e8ff" value=" ATTESTATION DE RÉUSSITE">[Service Scolarité] ATTESTATION DE RÉUSSITE</option>
                        <option style="background-color:#e8e8ff" value="PARCOURS D’ÉTUDES">[Service Scolarité] PARCOURS D’ÉTUDES</option>
                        <option style="background-color:#e8e8ff" value="SCANNE DES DIPLÔMES">[Service Scolarité] SCANNE DES DIPLÔMES</option>
                        <option style="background-color:#e8e8ff" value="RECLAMATION BOURSES">[Service Scolarité] RECLAMATION BOURSES</option>
                        <option style="background-color:#e8e8ff" value="ATTESTATION D’OBTENTION DU NIVEAU B2">[Service Scolarité] ATTESTATION D’OBTENTION DU NIVEAU B2</option>
                        <option style="background-color:#e8e8ff" value="AUTRE DEMANDE AU SERVICE SCOLARITE">[Service Scolarité] AUTRE DEMANDE AU SERVICE SCOLARITE</option>
                        <option style="background-color:#dcf894" value="CONVENTION ET DEMANDE DE STAGE">[la Secrétaire du Directeur] CONVENTION ET DEMANDE DE STAGE</option>
                        <option style="background-color:#dcf894" value="ATTESTATION D'ASSURANCE">[la Secrétaire du Directeur] ATTESTATION D'ASSURANCE</option>
                        <option style="background-color:#dcf894" value="AUTRE DEMANDE SECRETAIRE DE DIRECTION">[la Secrétaire du Directeur] AUTRE DEMANDE SECRETAIRE DE DIRECTION</option>
                    </select></div></div><br>
                    <div class="form-group"> 
                    </div><br>
                    <div>
                    <button type="submit" class="btn btn-primary" name="envoyer">Envoyer</button>
                    <a href="student .php" class="btn btn-secondary">Annuler</a>
                    </div>
                </fieldset>
            </form>
        </div>
