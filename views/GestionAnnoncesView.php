    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" id="d1">
                ...
                <br>
                <div id="contenu" style="margin: 5%;">
                    <div class="title" style="color: #FFE4C4;text-align:center;">Gestion des annonces</div>
                    <table class="table table-hover table-responsive table-striped" id="tableAnnonces">
                        <thead>
                            <tr>
                                <th>Titre</th>
                                <th>Description</th>
                        ...
                        <tbody>
                            ...
                            if (!empty($actualites)) {
                                foreach ($actualites as $row) {
                                    echo "<tr>";
                                    echo "<td>" . htmlspecialchars($row['titre_actu'], ENT_QUOTES, 'UTF-8') . "</td>";
                                    echo "<td>" . htmlspecialchars($row['msg_actu'], ENT_QUOTES, 'UTF-8') . "</td>";
                                    if ($row['type_img'] === 'pdf') {
                                    ...
                                    echo "<td><a class='btn btn-warning' href='../controllers/ModifAnnonceController.php?titr=" . urlencode($row['titre_actu']) . "'>Modifier</a></td>";
                                    echo "<td><a class='btn btn-danger' href='../controllers/SupAnnonceController.php?titre=" . urlencode($row['titre_actu']) . "' onclick='return confirm(\"Êtes-vous sûr de vouloir supprimer cette annonce ?\")'>Supprimer</a></td>";
                                    echo "</tr>";
                                }
                            } else {
                                echo "<tr><td colspan='5'>Aucune annonce trouvée</td></tr>";
                            }
                            ?>
                        </tbody>
                        <tfoot>
                            <tr>
                                <td colspan="1" style="text-align: right;">
                                    <div class="btn btn-success" onclick="window.location.href='../controllers/AjoutAnnonceController.php';">Ajouter une annonce</div>
                                </td>
                                <td colspan="4">
                                    <nav>
