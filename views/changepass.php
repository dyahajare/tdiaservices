   ...
   <div class="dropdown-list dropdown-menu dropdown-menu-right shadow " aria-labelledby="alertsDropdown">
        ...
        <fieldset>
            <form action="changepasshandler.php" method="post">
                ...
                <input type="password" id="form_login" name="oldpassword" class="form-control" required>
                <label>Nouveau mot de passe</label><br>
                <input type="password" id="form_password" name="newpassword" class="form-control" required>
                <label>Confirmer nouveau mot de passe</label><br>
                <input type="password" id="form_password" name="confnewpassword" class="form-control" required>
                <div style="margin-top: 20px">
                    <button type="submit" class="btn btn-primary" name="changer">Changer mot de passe</button>
