...
<!DOCTYPE html>
    ...
    background : linear-gradient(to bottom,   rgb(204, 202, 202), rgb(249, 249, 250)); }
                                             ...
                                             <div class="sub-menu-wrap" id="subMenu5">
                                                 <div class="sub-menu">
                                                     ...
                                                     <div style="background-color: aliceblue;width:70%;margin-left: 70px;height:auto;padding-top: 2%;border-radius: 10px;">
                                                         <ul style="list-style: none;padding-left: 2%;"><li><a href="" style="padding-left:5%;color:#3a3b45;">3 ème annee GC</a></li>
                ...
                <div class="depos">
                    <div class="text1">  Soumission de la version finale du PFE</div>
                   
                    <ul class="bullet-list">
                        <li class="text2">   <div > 
                            Veuillez remplir scrupuleusement le formulaire ci-dessous 
                            <span class="textt">Après soutenance.</span>
                        </div></li>
                        <li class="text3">La version finale du rapport à télécharger doit intégrer les remarques formulées lors de la soutenance.</li>
                        ...
                        <li class="text3">
                            Une fois que vous aurez soumis le formulaire en ligne, votre superviseur examinera attentivement votre rapport et procédera à sa validation, condition nécessaire à l'obtention de votre diplôme.</li>
                        ...
                        <div class="for"> 
                            <div class="texts">Soumission d'un rapport de PFE</div>
                        <form id="pfeForm" method="POST" enctype="multipart/form-data"> 
                        <span class="for1">Titre du sujet de PFE (<span class="textt">*</span>)</span>
                        <div class="input-group">
                                 
                                <textarea class="form-control" aria-label="With textarea" name="titre" required></textarea>
                              </div>
                              <div class="mb-3">
                                <span class="for1">Email Académique de l'Encadrant (<span class="textt">*</span>)</span>
                                <div class="input-group">
                                                           
                                                          <input class="form-control" aria-label="With textarea" name="email_encadrant" type="email">
                                                        </div></div>
                         <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="exampleFormControlSelect1" name="pfe_encadrant">
                                        <option value=""></option>
                        ...
                        <div class="mb-3">
                            <label for="titre" class="form-label"> Organisme d'accueil (Lieu de stage) (<span class="textt">*</span>)</label>
                            <input type="text" class="form-control" id="titre" placeholder=" " name="pfe_orglieu">
                        </div>
                        <span class="for1"> Coordonnées de l'organisme d'accueil (Adresse, télé et /ou fax, mail) (<span class="textt">*</span>)</span>
                        <div class="input-group">
                                     
                            <textarea class="form-control" aria-label="With textarea" name="pfe_orgtele"></textarea>
                          </div>
                        <div class="mb-3">
                            <label for="titre" class="form-label">  Nom et Prénom de l'encadrant dans l'organisme d'accueil (<span class="textt">*</span>)</label>
                            <input type="text" class="form-control" id="titre" placeholder=" " name="pfe_nom_prenom">
                        </div>
                        <div class="mb-3">
                            <label for="titre" class="form-label">  Email de votre encadrant dans l'organisme d'accueil (<span class="textt">*</span>)</label>
                            <input type="email" class="form-control" id="titre" placeholder=" " name="pfe_org_encadrant">
                        </div>
                        ...
                        <div class="input-group1"> 
                          ...
                          <button type="reset" class="btn btn-secondary ">Annuler</button></div>
                               ...
                               <script>
        document.getElementById('pfeForm').addEventListener('submit', function(event) {
            event.preventDefault();
            const formData = new FormData(this);
            fetch('../controllers/PfeController.php', {
                method: 'POST',
                body: formData
            })
