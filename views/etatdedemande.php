...
<table id="tableAffichage" class="table"> 
    <thead class="table-info" stle="background-color:blue">
        ...
        <td><?php echo $ligne['typeDemande'];?></td>
        <td><?php  if($ligne['réalisé']==0){
            echo "réalisée";
        }else {            echo " non réalisée" ;       }
