<?php
class ModifInfoClasseView {
    public static function render($nom, $profileImage, $prenom, $classeDetails, $buttonValue) {
        ?>
        <!doctype html>
        <html lang="en">
        <head>
        ...
        <body>
                ...
                <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th style="padding-left: 10%;">
                                        ...
                                        <a href="../controllers/GestionDemandesController.php" style="text-decoration: none;color: #FFE4C4;font-size: 95%; font-weight: normal; padding-left: 5%;">Gestion des demandes</a>
                                    </th>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" id="d1">
                        ...
                        <div class="card" style="background-color: rgba(19, 19, 97, 0.4); margin: 5%;margin-left: 20%; padding: 5%; border-radius: 10px; max-width: 700px;">
                            ...
                            <div class="card-body">
                            <form action="ModifInfoClasseController.php?buttonValue=<?php echo $buttonValue ?>" method="post" enctype="multipart/form-data" style="color: #FFE4C4;">
            ...
            <script>
                ...
                $.ajax({
                    url: 'ModifInfoClasseController.php', // Le chemin vers votre script PHP
