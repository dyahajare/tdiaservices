...
<!DOCTYPE html>
                ...
                <head>
                    <meta charset="UTF-8">
                    <title>Consulter les pfes</title>
                    <link href="../bootstrap-5.3.3-dist/css/bootstrap.min.css" rel="stylesheet">  
                    <link href="../css/student.css"  rel="stylesheet">
                    <link href="../css/consul.css" rel="stylesheet">
                    ...
                    <span><i class="fas fa-calendar fa-2x text-gray-300"></i></span>
                            ...
                            <div class="row1"> 
                                <div class="container-fluid" style="padding: 0;">
                                    <div class="consul">
                                        <div class="text1"> Recherche d'un rapport de PFE</div>
                                        <form id="pfeForm" method="POST" enctype="multipart/form-data"> 
                                            <div class="mb-3">
                                                <label for="titre" class="form-label">Titre</label>
                                                <input type="text" class="form-control" id="titre" placeholder=" Veuillez entrer le titre ou une partie de titre">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <label for="exampleFormControlSelect1" class="form-label"> Année Universitaire</label>
                                                <select class="form-select" id="exampleFormControlSelect1">
                                                    <option value=""></option>
