...
<body> 
   ...
   <div class="dropdown-list dropdown-menu dropdown-menu-right shadow " aria-labelledby="alertsDropdown">
        ...
        <strong style="color:blue;padding-left:2%;">Notif</strong><br>
            <div class="card-header">
            <?php
if (isset($_GET['titre_notif']) && isset($_GET['msg_notif'])) {
    $titre_notif = htmlspecialchars($_GET['titre_notif']);
    $notif_path = htmlspecialchars($_GET['msg_notif']);
}
?>
<strong><?php echo htmlspecialchars($titre_notif); ?></strong></div>
<div class="card-body">
<strong><?php echo htmlspecialchars($notif_path); ?></strong></div>
    </p>
</div>
