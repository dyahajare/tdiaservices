<?php
class GestionPersonnelView {
    public static function render($nom, $profileImage, $prenom, $personnel, $page_number, $total_pages) {
        ?>
        <!doctype html>
        <html lang="en">
        <head>
                        ...
                        <table class="table table-responsive" style="margin-left: 2%;">
                            ...
                            <tbody class="table-group-divider">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div><a class='btn btn-warning' href='../controllers/ModifPersonnelController.php?cin=<?php echo urlencode($row['cin']); ?>'>Modifier</a></div>
                                    </td>
                                    <td>
                                        <a class='btn btn-danger' href='../controllers/SupPersonnelController.php?cin=<?php echo urlencode($row['cin']); ?>' onclick='return confirm("Êtes-vous sûr de vouloir supprimer cette personne ?")'>Supprimer</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                            <tfoot>
                                <tr>
                                    <td colspan="5" style="text-align: right;">
                                        <div class="btn btn-success" onclick="window.location.href='../controllers/AjoutPersonnelController.php';">Ajouter une personne</div>
                                    </td>
                                    <td colspan="6">
                                        <!-- Pagination -->
                                        <nav>
