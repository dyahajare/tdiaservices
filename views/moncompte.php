...
$id=$_SESSION['user']['classe'] ?? 'default_class';
    $req=('SELECT * FROM etudiant WHERE emailAcadémique=?');
    $params=array($id);
    $sp=$con->prepare($req);
    $sp->execute($params); 
    $res=$sp->fetchALL();
           ...
           <div class="topbar" style="background-color:rgb(238, 237, 237);" style="height: 80px;" style="margin-top:0%;">
            ...
            <div class="row1" style=" background: linear-gradient(to bottom,   rgb(204, 202, 202), rgb(249, 249, 250));"> 
                ...
                <div class="container-fluid" style="background-color:white;">
                    <div class="moncompte" style="float: right;padding-top:2%;margin-right:0%">
                            <div style="display: flex;flex-direction: column;">
                                <img src="<?php echo ($image_path); ?>" style="width:300px;height:300px;">
                                <a href="chnagerpdp.php"><button style="background-color:#4E73DF;color:white;height:20%;border-color: #FFFFFF;width:160px;margin-top:20px;margin-left:70px;border-radius:10px;">Changer photo de profil</button></a>
                            </div>
                    </div>
                    <h4 style="font-weight: bold;color: darkgray ;">IDENTIFICATION DE L'ETUDIANT</h4>
                    <table style="color:darkgray ;"><tbody>
                    <?php foreach($res as $ligne){?>
                    <tr><td style="color:#4E73DF">CNE :</td>
                    <td style="padding-left:8%;"><?php echo $ligne['cne'];?></td></tr>
                    <tr>
                    <td style="color:#4E73DF;font-weight:600px;">Nom :</td>
                    <td style="padding-left:20px;">CHGARI</td></tr>
                    <tr><td style="color:#4E73DF">Nom en arabe :</td><td style="padding-left:8%;"><?php echo $ligne['nomArabe'];?></td></tr>
                    <tr><td style="color:#4E73DF">Prénom :</td><td style="padding-left:8%;"><?php echo $ligne['prenom'];?></td></tr>
                    <tr><td style="color:#4E73DF">Prénom en arabe :</td><td style="padding-left:8%;"><?php echo $ligne['prenomArabe'];?></td><tr>
                    <tr><td style="color:#4E73DF">CIN :</td><td style="padding-left:8%;"><?php echo $ligne['cin'];?></td></tr>
                    <tr><td style="color:#4E73DF">Sexe :</td><td style="padding-left:8%;"><?php echo $ligne['sexe'];?></td></tr>
                    <tr><td style="color:#4E73DF">Pays :</td><td style="padding-left:8%;"><?php echo $ligne['pays'];?></td></tr><?php }?>
                </tbody></table>
                <h4 style="color:darkgray ;"> NAISSANCE DE L'ETUDIANT</h4>
                <table>
                <tbody style="color:darkgray;">
                <?php foreach($res as $ligne){?>
                <tr>
                <td style="color:#4E73DF;font-weight:600px;">Date de naissance :</td>
                <td style="padding-left:8%;"><?php echo $ligne['dateNaissance'];?></td></tr>
                <tr><td style="color:#4E73DF;font-weight:600px;">Ville de naissance :</td>
                <td style="padding-left:8%;"><?php echo $ligne['villeNaissance'];?></td>
                </tr>
                <tr><td style="color:#4E73DF;font-weight:600px;">Ville de naissance :</td><td style="padding-left:8%;"><?php echo $ligne['villeNaissanceArabe'];?></td></tr>
                <tr><td style="color:#4E73DF;font-weight:600px;">Province de naissance :</td><td style="padding-left:8%;"><?php echo $ligne['provinceNaissance'];?></td></tr>
                <tr><td style="color:#4E73DF;font-weight:600px;">Lieu de naissance :</td><td style="padding-left:8%;"><?php echo $ligne['lieuNaissance'];?></td></tr>
                <tr><td style="color:#4E73DF;font-weight:600px;">Lieu de naissance  :</td><td style="padding-left:8%;"><?php echo $ligne['lieuNaissanceArabe'];?></td></tr><?php }?>
              </tbody>
              </table>
             <h4 style="color:darkgray ;"> COORDONNEES DE L'ETUDIANT</h4>  
             <table>
                <tbody style="color:darkgray;">
                <?php foreach($res as $ligne){?>
                <tr><td style="color:#4E73DF;font-weight:600px;">Télé :</td>
                <td style="padding-left:8%;"><?php echo $ligne['telephone']; ?></td></tr><tr>
                <td style="color:#4E73DF;font-weight:600px;">Email Personnel :</td>
                <td style="padding-left:8%;"><?php echo $ligne['emailPerso']; ?></td></tr>
                <tr><td style="color:#4E73DF;font-weight:600px;">Email Institutionnel:</td>
                <td style="padding-left:8%;"><?php echo $ligne['emailAcadémique']; ?></td></tr><?php }?>
            </tbody>
            </table>
            <a href="chnagercordonne.html"><button style="background-color:#4E73DF;color:white;height:5%;border-color: #FFFFFF;width:160px;margin-top:20px;margin-left:70px;border-radius:10px;">Modifier mes cordonnees</button></a>
            <h4 style="color:darkgray ;"> PARENTS DE L'ETUDIANT</h4> 
            <table >
            <?php foreach($res as $ligne){?>
            <tr><td style="color:#4E73DF;font-weight:600px;">Télé parents :</td>
            <td style="padding-left:8%;"><?php echo $ligne['teleParent'];?></td></tr>
            <tr><td style="color:#4E73DF;font-weight:600px;">Catégorie socioprofessionnelle du PERE:</td>
            <td style="padding-left:8%;"><?php echo $ligne['ProfessionPere'];?></td></tr>
            <tr><td style="color:#4E73DF;font-weight:600px;">Catégorie socioprofessionnelle de la MERE :</td>
            <td style="padding-left:8%;"><?php echo $ligne['ProfessionMere'];?></td></tr>
            <tr><td style="color:#4E73DF;font-weight:600px;">Province des parents :</td>
            <td style="padding-left:8%;"><?php echo $ligne['ProvinceParent'];?></td> </tr>
                <tr><td style="color:#4E73DF;font-weight:600px;">Adresse des parents :</td>
                <td style="padding-left:8%;"><?php echo $ligne['adresseParent'];?></td> </tr><?php } ?>
                </tbody>
            </table>
            <h4 style="color:darkgray ;"> BAC DE L'ETUDIANT</h4> 
            <table>
            <tbody style="color:darkgray">
            <?php foreach($res as $ligne){?>
            <tr><td style="color:#4E73DF;font-weight:600px;">Année d'obtention BAC :</td>
            <td  style="padding-left:8%;"><?php echo $ligne['anneeObtentionBac']; ?></td></tr>
            <tr><td style="color:#4E73DF;font-weight:600px;">Type BAC :</td>
            <td  style="padding-left:8%;"><?php echo $ligne['typeBac']; ?></td></tr>
            <tr><td style="color:#4E73DF;font-weight:600px;">Mention BAC :</td>
            <td  style="padding-left:8%;"><?php echo $ligne['mentionBac']; ?></td></tr>
            <tr><td style="color:#4E73DF;font-weight:600px;">Prov. d'obtention du BAC :</td>
            <td  style="padding-left:8%;"><?php echo $ligne['provinceObtentionBac']; ?></td></tr><tr>
            <td style="color:#4E73DF;font-weight:600px;" >Académie :</td>
            <td  style="padding-left:8%;"><?php echo $ligne['académie']; ?></td></tr>
            <tr><td style="color:#4E73DF;font-weight:600px;">Lycée :</td>
            <td  style="padding-left:8%;"><?php echo $ligne['lycée']; ?></td></tr>
            <tr><td style="color:#4E73DF;font-weight:600px;">Type Lycée :</td>
            <td  style="padding-left:8%;"><?php echo $ligne['typeLycée']; ?></td></tr><?php } ?>
           </tbody>
            </table>
            <h4 style="color:darkgray ;"> AUTRES INFORMATIONS</h4>
            <table>
            <tbody style="color:darkgray">
            <?php foreach($res as $ligne){?>
            <tr><td style="color:#4E73DF;font-weight:600px;">Situation familiale :</td>
            <td style="padding-left:8%;"><?php echo $ligne['situationFamiliale'];?></td></tr>
            <tr><td style="color:#4E73DF;font-weight:600px;">Handicape :</td>
            <td style="padding-left:8%;"><?php echo $ligne['handicape'];?></td></tr>
            <tr><td style="color:#4E73DF;font-weight:600px;">Année Première Insc. en ens. sup :</td>
            <td style="padding-left:8%;"><?php echo $ligne['AnnéeInscriptionSup'];?></td></tr>
            <tr><td style="color:#4E73DF;font-weight:600px;">Année Première Insc. en uinv. ma :</td>
            <td style="padding-left:8%;"><?php echo $ligne['AnnéeInscrUAE'];?></td></tr>
            <tr><td style="color:#4E73DF;font-weight:600px;">Année Première Insc. à UAE : </td>
            <td style="padding-left:8%;"><?php echo $ligne['AnnéeInscrUAE'];?></td></tr>
            <tr><td style="color:#4E73DF;font-weight:600px;">Source :</td>
            <td style="padding-left:8%;"><?php echo $ligne['source'];?></td><tr><?php } ?>
        </tbody>
    </table>
        </div>
        </div>
