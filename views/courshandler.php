...
<body> 
   ...
   <div class="dropdown-list dropdown-menu dropdown-menu-right shadow " aria-labelledby="alertsDropdown">
        ...
        <strong style="color:blue;padding-left:2%;">Cours</strong><br>
            <div class="card-header">
            <?php
         if (isset($_GET['titre_cours']) && isset($_GET['file'])) {
        $titre_actu = $_GET['titre_cours'];
        $_pdfpath=$_GET['file'];
}
?>
        <strong><?php echo($_SESSION['titre_cours']); ?></strong></div>
            <div class="card-body">
            <p> Le cours complet via le fichier attaché ci-dessous: <br>
    <a href="<?php echo htmlspecialchars('../uploads/' . $_pdfpath); ?>" download="<?php echo htmlspecialchars($_pdfpath); ?>">Télécharger le cours</a>
</p>
    </div>
    </div>
        </div>
