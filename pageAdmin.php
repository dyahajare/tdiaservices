        ...
        <div class="row">
            ...
            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12" id="d1">
                ...
                <div id="box" class="d-flex flex-column flex-md-row">
                    <button style="background-color:rgb(128, 160, 208);border-radius: 15px;" class="mb-2 mb-md-0 mr-md-2" onclick="window.location.href='AjoutEtudiant.php'">
                    ...
                    <button style="background-color:rgb(52, 189, 182);border-radius: 10px;" class="mb-2 mb-md-0 mr-md-2 " onclick="window.location.href='gestionAnnonces.php'">
                        <i class="fa-solid fa-bullhorn" style="color: rgb(171, 169, 169);padding-right: 8%;"></i>
                        <h6>Annonces</h6>
                    </button>
                    <button style="background-color:rgb(39, 139, 39);border-radius: 10px;" class="mb-2 mb-md-0 mr-md-2" onclick="window.location.href='classe.php'">
                        <i class="fa-solid fa-clipboard" style="color: rgb(171, 169, 169);padding-right: 8%;"></i>
                        <h6>Notes</h6>
                    </button>
                    <button style="background-color:rgb(239, 239, 39);border-radius: 10px;" class="mb-2 mb-md-0 mr-md-2" onclick="window.location.href='Personnels.php'">
                                        ...
                                        <div class="card-body">
                                            <?php 
                                             ...
                                             while ($row = $req->fetch(PDO::FETCH_ASSOC)) {
                                                echo '<div class="row"><div class="row"><div class="col-12 text-white">' . $row['titre_actu'] . '<br></div></div></div>';
                                                echo '<hr>';
                                             }
                                            ?>
                                            <div class="mt-1 text-center small">
                                                <span class="mr-1">
                                                    <i class="fas fa-circle text-info"></i> <a href="gestionAnnonces.php"> Lire plus d'actualités</a> 
                                                </span>
                                            </div>
                                        </div>
                                    </div>
